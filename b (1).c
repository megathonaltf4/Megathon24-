...
bool checkAndHandleCollision2(int ballX, int ballY, int ballRadius, bush line) {
    int closestX = fmax(line.x1, fmin(ballX, line.x2));
    int closestY = fmax(line.y1, fmin(ballY, line.y2));
    int distanceX = ballX - closestX;
    int distanceY = ballY - closestY;
...
bool checkAndHandleCollision3(int ballX, int ballY, int ballRadius, spiky line) {
    int closestX = fmax(line.x1, fmin(ballX, line.x2));
    int closestY = fmax(line.y1, fmin(ballY, line.y2));
    int distanceX = ballX - closestX;
    int distanceY = ballY - closestY;
...
bool checkAndHandleCollision5(int ballX, int ballY, int ballRadius, Fire line) {
    int closestX = fmax(line.x1, fmin(ballX, line.x2));
    int closestY = fmax(line.y1, fmin(ballY, line.y2));
    int distanceX = ballX - closestX;
    int distanceY = ballY - closestY;
...
for (int i = 0; i < 20; i++) {
    if (checkAndHandleCollision2(ballX, ballY, ballRadius, bushes[i])){
        // Display end screen on both windows        
        // Wait for 2 seconds
        SDL_Delay(2000);
        // Clean up and exit
...
for (int i = 0; i <8; i++) {
    if (checkAndHandleCollision3(ballX, ballY, ballRadius, spik[i])){
        // Display end screen on both windows        
        // Wait for 2 seconds
        SDL_Delay(2000);
        // Clean up and exit
...
for (int i = 0; i <4; i++) {
    if (checkAndHandleCollision5(ballX, ballY, ballRadius, fires[i])){
        // Display end screen on both windows        
        // Wait for 2 seconds
        SDL_Delay(2000);
        // Clean up and exit
